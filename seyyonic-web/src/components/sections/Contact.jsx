          ...
          >
            <div className="glass-card p-6 flex items-center gap-6 group hover:border-brand-orange/50 transition-colors">
              ...
              <div>
                ...
                <p className="text-gray-400 font-poppins">hello@seyyonic.ai</p>
              </div>
            </div>
            ...
            <div className="glass-card p-6 flex items-center gap-6 group hover:border-brand-gold/50 transition-colors">
              ...
              <div>
                <h4 className="text-white font-orbitron font-semibold mb-1">Headquarters</h4>
                <p className="text-gray-400 font-poppins">Innovation District, Silicon Valley</p>
              </div>
            </div>
